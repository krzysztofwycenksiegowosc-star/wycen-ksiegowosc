  ...
  return (
    <section className="py-20 md:py-24 bg-white">
      <div className="max-w-5xl mx-auto px-6">
        <div className="rounded-[2.25rem] bg-gradient-to-br from-slate-50 via-white to-emerald-50/70 border border-slate-200/70 px-6 py-12 md:px-12 md:py-16 text-center shadow-sm">
          <span className="inline-flex items-center justify-center rounded-full bg-emerald-50 border border-emerald-100 px-4 py-2 text-sm font-semibold text-emerald-700 mb-6">
            Sprawdź wyceny. Spokojnie zdecyduj.
          </span>

          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900 tracking-tight max-w-4xl mx-auto mb-5">
            Sprawdź cenę, zanim zaczniesz szukać biura na własną rękę
          </h2>

          <p className="text-lg text-slate-500 max-w-3xl mx-auto leading-relaxed mb-8">
            Dostajesz niezobowiązujące wyceny dopasowane do Twojej firmy i priorytetów.
            <strong className="font-semibold text-slate-700"> Bez udostępniania Twoich danych</strong> biurom rachunkowym.
            Bez lawiny telefonów i maili.
          </p>
